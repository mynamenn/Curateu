...
<div class="p-2 lg:w-1/2 w-full">
    <div class="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-4 sm:flex-row flex-row transform hover:-translate-y-1 transition duration-500 ease-in-out"
