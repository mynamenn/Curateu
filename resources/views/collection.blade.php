...
<div class="flex-column pt-10 pb-6 px-4 rounded-lg overflow-hidden align items-center justify-center text-center">
    <img class="w-24 h-24 mb-4 inline-flex items-center rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0" src={{
        $collection->photo }} alt="content">
    ...
    <div class="flex items-center justify-center mb-4">
        ...
        <button type="button" onclick="showTagForm()" class="ml-2 hover:bg-gray-200 p-1 rounded-lg">
